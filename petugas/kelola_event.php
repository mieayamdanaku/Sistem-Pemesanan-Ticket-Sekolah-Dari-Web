...
if(isset($_GET['hapus'])){
    ...
    // Hapus semua tiket yang terhubung dengan event ini dulu
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Event | Panel Petugas</title>
...
<body>
    ...
    <?php include 'sidebar.php'; // Sesuaikan dengan file sidebar petugas Anda ?>
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-3 py-3 fw-bold"><?= htmlspecialchars($e['judul']) ?></td>
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-3 py-3 fw-bold text-muted"><?= htmlspecialchars($ex['judul']) ?></td>
